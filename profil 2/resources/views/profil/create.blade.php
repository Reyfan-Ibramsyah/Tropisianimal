        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control"  name="isi_judul" placeholder="Penjelasan"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>visi:</strong>
                    <input class="form-control"  name="visi" placeholder="Visi">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Isi visi:</strong>
                    <textarea class="form-control"  name="isi_visi" placeholder="Isi Visi"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Misi:</strong>
                    <input class="form-control"  name="misi" placeholder="Misi"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Isi Misi:</strong>
                    <textarea class="form-control"  name="isi_misi" placeholder="Isi Misi"></textarea>
                </div>
            </div>
